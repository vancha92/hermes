...
const ScrollTopButton = () => {
  ...
  return (
    <div onClick={handleClick} className={state ? "" : "hidden"}>
      {windowWidth > 1023 ? (
        <div className="z-50 absolute -bottom-1 translate-y-full -right-0.5 cursor-pointer bg-accent hover:bg-slate-500 rounded-l-lg border-b-2 border-l-2 border-t-2 border-r-0 border-base-300 w-10 lg:w-auto h-10 lg:h-auto shadow-md shadow-black">
